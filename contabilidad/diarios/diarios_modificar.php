    ...
    <nav >
            <ul class="menu">
                ...
                <ul>
                    ...
                    <li><a href="diarios_modificar.php">DIARIOS</a></li>
          ...
          <table id="datos">
            <tbody>
             ...
             while($row=$resultado->fetch_assoc()){
              ...
              <td><a href="diarios_modificar.php?id=<?php echo $row['drs_id']?>"><img src="../../imagenes/editar.png"  width="15" height="15"alt=""></a></td>
              <td><a href="diarios_eliminar.php?id=<?php echo $row['drs_id']?>"><img src="../../imagenes/borrar.png"  width="15" height="15"alt=""></a></td>
              </tr>
              <?php   
            }
              ?>                                  
