        ...
        <nav >
            <ul class="menu">
                ...
                <ul>
                   ...
                   <li><a href="../cuentas_a_pagar/cuentas_a_pagar.php">CUENTAS A PAGAR</a></li>
                   <li><a href="../retenciones/retenciones.php">RETENCIONES</a></li>
                   <li><a href="../formas_de_pagos/formas_de_pagos.php">FORMAS DE PAGO</a></li>
                   <li><a href="../facturacion_electronica/facturacion_electronica.php">FACTURACION ELECTRONICA</a></li>
                </ul></li>
                <li><a href="">VENTAS</a>
                <ul>
