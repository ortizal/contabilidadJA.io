...
<html lang="en">
    ...
    <nav >
            <ul class="menu">
                ...
                <li><a href="">BANCOS</a>
                <ul>
                   <li><a href="crear_banco.php">CREAR BANCO</a></li>
                   <li><a href="../conciliacion_bancaria/conciliacion_bancaria.php">CONCILIACION BANCARIA</a></li>
                   <li><a href="../tarjetas_de_creditos/tarjetas-de-creditos.php">TARJETAS DE CRÉDITOS</a></li>
                   <li><a href="../libro_bancos/libro_bancos.php">LIBRO BANCOS</a></li>
               </ul></li>
                ...
                <li><a href="../../activos_fijos/activos_fijos.php">ACTIVOS FIJOS</a></li>
            </ul></li>
    </nav> 
